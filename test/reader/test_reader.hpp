...
namespace lzhlib::test
{
    namespace reader
    {
        namespace literal_reader
        {
            ...
            inline void test()
            {
                using lzhlib::literal_reader::type;
                using lzhlib::literal_reader::type_list;
                using lzhlib::literal_reader::predefined_reader;
                using lzhlib::tuple::arg;
                using reader = lzhlib::literal_reader::literal_reader<type_list<type<int>,
                                                                                type<std::string>,
